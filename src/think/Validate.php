...
namespace message\think;

use Closure;
use message\think\exception\ValidateException;
use message\think\helper\Str;
use message\think\validate\ValidateRule;
...
class Validate
{
     ...
     * @return array
     */
    protected function errorMsgIsArray(array $msg, $rule, string $title): array
    {
